...
config :my_phoenix_app, MyPhoenixAppWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "7KXSDwIUbEyD9daiyc9kNQl4TEwtLitMTdVCQ3Ff+8v+asxtTFH/TdQ7CmGPhJbQ",
  watchers: [
...
# Google Maps API配置
config :my_phoenix_app, :google_maps_api_key, System.get_env("GOOGLE_MAPS_API_KEY", "")
